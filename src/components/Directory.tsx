...
const DirectoryContent: React.FC = () => {
  ...
  const {
    ...
    isSubmitModalOpen: isModalOpen, setIsSubmitModalOpen: setIsModalOpen,
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2 sm:gap-3 pointer-events-auto">
            ...
            <div className="flex items-center gap-2.5 mr-1 sm:mr-3">
              <div
                className="w-8 h-8 rounded-[10px] flex items-center justify-center shadow-sm cursor-pointer hover:scale-105 transition-transform bg-gradient-to-br from-[#7c3aed] to-[#a855f7] shadow-[0_4px_14px_rgba(124,58,237,0.4)]"
              >
                <div className="w-2 h-2 bg-white rounded-full opacity-90" />
              </div>
              <span
                className="text-[15px] font-bold tracking-tight hidden sm:block text-[rgba(15,15,35,0.85)] dark:text-[rgba(240,240,255,0.9)]"
              >
                Nexus
              </span>
            </div>
          ...
          <div
            className="hidden md:flex items-center gap-1 rounded-full p-1 backdrop-blur-md pointer-events-auto bg-[rgba(255,255,255,0.8)] dark:bg-[rgba(30,25,50,0.6)] border border-[rgba(255,255,255,0.9)] dark:border-[rgba(255,255,255,0.08)] shadow-[0_4px_12px_rgba(80,60,160,0.06)] dark:shadow-[0_4px_12px_rgba(0,0,0,0.2)]"
          >
        ...
        >
          ...
          <section className="w-full flex flex-col items-center text-center px-4 pt-10 pb-8">
            <h1
              className="font-display text-[32px] sm:text-[42px] md:text-[50px] lg:text-[56px] font-black tracking-tight leading-[1.1] mb-3 animate-fade-up text-[rgba(10,8,30,0.90)] dark:text-[rgba(240,240,255,0.97)] tracking-[-0.025em]"
            >
            ...
            <div className="w-full max-w-[580px] animate-fade-up" style={{ animationDelay: '140ms' }}>
              ...
              >
                ...
                >
                  <SearchIcon size={16} className="text-[rgba(100,80,160,0.6)] dark:text-[rgba(180,160,255,0.5)]" />
                  <span
                    className="flex-1 text-left text-[14.5px] font-medium text-[rgba(100,80,160,0.7)] dark:text-[rgba(180,160,255,0.45)]"
                  >
                    Search for spatial experiences, tools, and resources...
                  </span>
                  <kbd
                    className="hidden sm:inline-flex items-center gap-0.5 text-[11px] font-bold px-1.5 py-0.5 rounded-md border-[rgba(200,190,240,0.6)] dark:border-[rgba(255,255,255,0.12)] border text-[rgba(120,90,200,0.5)] dark:text-[rgba(180,160,255,0.45)] bg-[rgba(255,255,255,0.6)] dark:bg-[rgba(255,255,255,0.04)]"
                  >
                    ⌘K
                  </kbd>
                </button>
            ...
            <div className="flex items-center gap-2 mt-5 flex-wrap justify-center max-w-[700px] animate-fade-up" style={{ animationDelay: '200ms' }}>
              ...
              {activeCategory !== 'All Tools' && SIDEBAR_CATEGORIES.indexOf(activeCategory) >= 8 && (
                <span
                  className="px-3.5 py-1.5 rounded-full text-[12px] font-semibold bg-[rgba(124,58,237,0.35)] border border-[rgba(124,58,237,0.5)] text-[#7c3aed] dark:text-[#c084fc]"
                >
                  {activeCategory}
                </span>
              )}
          ...
          <section className="w-full max-w-[1300px] px-4 md:px-6">
            ...
            {fetchError ? (
              <div className="flex flex-col items-center justify-center py-20 text-center animate-fade-in">
                ...
                <h3 className="text-[20px] font-bold text-[rgba(10,8,30,0.88)] dark:text-[rgba(240,235,255,0.95)] mb-2">Something went wrong</h3>
                <p className="text-[14px] text-[rgba(80,60,140,0.6)] dark:text-[rgba(180,165,235,0.7)] max-w-[400px]">{fetchError}</p>
                <button onClick={() => window.location.reload()} className="mt-5 px-5 py-2.5 rounded-full bg-[var(--color-primary)] text-white font-semibold text-[14px]">Try Again</button>
              </div>
            ) : isLoading ? (
              viewMode === 'grid' ? (
              ...
              <div className="flex flex-col items-center justify-center py-28 text-center">
                <div
                  className="w-16 h-16 rounded-2xl flex items-center justify-center mb-5 bg-[rgba(124,58,237,0.08)] dark:bg-[rgba(124,58,237,0.12)] border border-[rgba(124,58,237,0.2)]"
                >
        ...
        >
          <div
            className="pointer-events-auto flex items-center gap-0.5 sm:gap-1 px-1.5 sm:px-2 py-2 rounded-2xl max-w-full overflow-x-auto no-scrollbar bg-[rgba(255,255,255,0.50)] dark:bg-[rgba(18,16,40,0.55)] backdrop-blur-[28px] backdrop-saturate-[2] border border-[rgba(255,255,255,0.72)] dark:border-[rgba(255,255,255,0.10)] shadow-[0_20px_40px_rgba(0,0,0,0.10),inset_0_1px_0_rgba(255,255,255,0.9)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.06)]"
          >
            {NAV_ITEMS.map(item => {
        ...
        <AutoCaptureModal isOpen={isModalOpen} onClose={() => { setIsModalOpen(false); if (activeNav === 'submit') setActiveNav('discover'); }} />
        <AuthModal />
        <UserProfile accentColor={accentColor} setAccentColor={setAccentColor} fontFamily={fontFamily} setFontFamily={setFontFamily} />
        <LeaderboardModal />
        <AdminPanel />
      </div>
    </ErrorBoundary>
