...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  edgeSensitivity = 30,
  glowColor = '40 80 80',
  backgroundColor = 'transparent', // Modified from #120F17 to transparent for Liquid Glass effect
  borderRadius = 28,
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col relative overflow-auto z-[1] rounded-[inherit]">{children}</div>
    </div>
  );
};
