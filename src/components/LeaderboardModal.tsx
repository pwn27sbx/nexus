...
const BADGES = [
  {
    ...
    icon: '👑',
    minApproved: 30,
    color: 'text-slate-300 bg-slate-100 dark:bg-slate-800',
  },
  {
    name: 'Gold',
    icon: '🥇',
                ...
                >
                  ...
                  {leaders[1] && (
                    <LeaderPodiumCard
                      ...
                      levelColor={
                        LEVEL_COLORS[leaders[1].level || 'Explorer'] || LEVEL_COLORS.Explorer
                      }
                      isDark={isDark}
                      isFirst={false}
                    />
                  ...
                  {leaders[0] && (
                    <LeaderPodiumCard
                      ...
                      levelColor={
                        LEVEL_COLORS[leaders[0].level || 'Explorer'] || LEVEL_COLORS.Explorer
                      }
                      isDark={isDark}
                      isFirst
                    />
                  ...
                  {leaders[2] && (
                    <LeaderPodiumCard
                      ...
                      levelColor={
                        LEVEL_COLORS[leaders[2].level || 'Explorer'] || LEVEL_COLORS.Explorer
                      }
                      isDark={isDark}
                      isFirst={false}
                    />
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        color: 'white',
                        background:
                          LEVEL_COLORS[leader.level || 'Explorer'] || LEVEL_COLORS.Explorer,
                        border: isDark
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        ...
                        <span
                          style={{
                            fontSize: '10px',
                            color: isDark ? 'rgba(160,145,220,0.4)' : 'rgba(120,90,180,0.4)',
                          }}
                        >
...
const LeaderPodiumCard: React.FC<LeaderRowProps> = ({
  leader,
  rank,
  badge,
  levelColor,
