...
const SkeletonCard: React.FC<SkeletonCardProps> = ({ isDark }) => (
  ...
  >
    ...
    <div
      style={{
        ...
        borderBottom: isDark
          ...
          : '1px solid rgba(200,190,240,0.3)',
      }}
    >
      <div style={{ display: 'flex', gap: '4px' }}>
        {['#ff5f5766', '#febc2e66', '#28c84066'].map((c) => (
          <div
            key={c}
            style={{ width: '7px', height: '7px', borderRadius: '50%', background: c }}
          />
        ))}
      </div>
      <div
    ...
    <div
      className="skeleton-pulse"
      style={{ width: '100%', paddingBottom: '60%', position: 'relative' }}
    >
    ...
    {/* Info skeleton */}
    <div
      style={{ padding: '12px 14px 14px', display: 'flex', flexDirection: 'column', gap: '8px' }}
    >
      ...
      >
        <div
          className="skeleton-pulse"
          style={{ width: '64px', height: '18px', borderRadius: '100px' }}
        />
        <div
          className="skeleton-pulse"
          style={{ width: '40px', height: '12px', borderRadius: '4px' }}
        />
      </div>
    </div>
  </div>
